...
@Serializable
data class GoldenFileTestCases(val cases: MutableMap<String, String> = mutableMapOf()) {
    companion object {
        ...
        fun String.getOrUpdateExpected(key: String, goldenFile: Path) =
                    ...
                    cases.cases[key]
                        ...
                        .fold(
                            ifEmpty = {
                                ...
                                writeGoldenFile(cases, goldenFile)
                                    .fold(
                                        { println("Warning: $it") },
