...
class DataFusionBallista(val versions: Versions.DataFusionBallistaVersion) : Renderable  {

  override fun render(
    env: Environment,
  ): Either<String, String> = `package`.render(versions, DataFusionBallistaVersionFetcher, env)
