 ...
 */
@Serializable
public data class RuntimeClassList(
  public val items: List<RuntimeClass>,
  public val metadata: ListMeta,
) : Resource {
  @SerialName("apiVersion")
  override val apiVersion: String = "node.k8s.io/v1"

  @Transient
  override val group: String = "node.k8s.io"

  @Transient
  override val version: String = "v1"

  @SerialName("kind")
  override val kind: String = "RuntimeClassList"
}