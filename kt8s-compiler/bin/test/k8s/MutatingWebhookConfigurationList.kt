 ...
 */
@Serializable
public data class MutatingWebhookConfigurationList(
    public val items: List<MutatingWebhookConfiguration>,
    ...
    @SerialName("kind") override val kind: String = "MutatingWebhookConfigurationList"
}
