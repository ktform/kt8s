...
/**
 * @param name name is the user group that matches, or "*" to match all user groups. See
 ...
 */
@Serializable
public data class GroupSubject(public val name: String) : Resource {
    ...
    @SerialName("kind") override val kind: String = "GroupSubject"
}
