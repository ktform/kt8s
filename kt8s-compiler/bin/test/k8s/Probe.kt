 ...
 * @param initialDelaySeconds Number of seconds after the container has started before liveness
 *   probes are initiated. More info:
 *   https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
 * @param periodSeconds How often (in seconds) to perform the probe. Default to 10 seconds. Minimum
 *   value is 1.
 ...
 *   This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate. Minimum
...
public data class Probe(
    ...
    @SerialName("kind") override val kind: String = "Probe"
}
