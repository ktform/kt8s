 ...
 * @param format format is an optional OpenAPI type definition for this column. The 'name' format is
 ...
 *   details.
 * @param jsonPath jsonPath is a simple JSON path (i.e. with array notation) which is evaluated
 *   against each custom resource to produce the value for this column.
 * @param name name is a human readable name for the column.
 * @param priority priority is an integer defining the relative importance of this column compared
 *   to others. Lower numbers are considered higher priority. Columns that may be omitted in limited
...
public data class CustomResourceColumnDefinition(
    ...
    @SerialName("kind") override val kind: String = "CustomResourceColumnDefinition"
}
