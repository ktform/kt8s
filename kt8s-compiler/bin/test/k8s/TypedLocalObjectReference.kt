 ...
 */
@Serializable
public data class TypedLocalObjectReference(public val apiGroup: String, public val name: String) :
    Resource {
    ...
    @SerialName("kind") override val kind: String = "TypedLocalObjectReference"
}
