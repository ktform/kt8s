...
/**
 * @param collisionCount Count of hash collisions for the DaemonSet. The DaemonSet controller uses
 ...
 * @param currentNumberScheduled The number of nodes that are running at least 1 daemon pod and are
 *   supposed to run the daemon pod. More info:
 *   https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/
 * @param desiredNumberScheduled The total number of nodes that should be running the daemon pod
 *   (including nodes correctly running the daemon pod). More info:
 *   https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/
 * @param numberAvailable The number of nodes that should be running the daemon pod and have one or
 *   more of the daemon pod running and available (ready for at least spec.minReadySeconds)
 * @param numberMisscheduled The number of nodes that are running the daemon pod, but are not
 *   supposed to run the daemon pod. More info:
 *   https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/
 * @param numberReady numberReady is the number of nodes that should be running the daemon pod and
 *   have one or more of the daemon pod running with a Ready Condition.
 * @param numberUnavailable The number of nodes that should be running the daemon pod and have none
...
public data class DaemonSetStatus(
    ...
    @SerialName("kind") override val kind: String = "DaemonSetStatus"
}
