 ...
 *   execution (e.g. due to an update), the system may or may not try to eventually evict the pod
 *   from its node.
 */
@Serializable
public data class NodeAffinity(
    public val preferredDuringSchedulingIgnoredDuringExecution: List<PreferredSchedulingTerm>,
    public val requiredDuringSchedulingIgnoredDuringExecution: NodeSelector,
) : Resource {
    ...
    @SerialName("kind") override val kind: String = "NodeAffinity"
}
