 ...
 * @param roleRef RoleRef can reference a Role in the current namespace or a ClusterRole in the
 *   global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. This
 *   field is immutable.
...
public data class RoleBinding(
    ...
    @SerialName("kind") override val kind: String = "RoleBinding"
}
