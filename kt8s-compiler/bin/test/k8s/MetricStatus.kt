...
/**
 * @param containerResource container resource refers to a resource metric (such as those specified
 *   in requests and limits) known to Kubernetes describing a single container in each pod in the
 ...
 * @param type type is the type of metric source. It will be one of "ContainerResource", "External",
...
public data class MetricStatus(
    ...
    @SerialName("kind") override val kind: String = "MetricStatus"
}
