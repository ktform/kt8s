 ...
 */
@Serializable
public data class ReplicationControllerList(
    public val items: List<ReplicationController>,
    ...
    @SerialName("kind") override val kind: String = "ReplicationControllerList"
}
