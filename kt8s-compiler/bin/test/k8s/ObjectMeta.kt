...
/**
 * @param annotations Annotations is an unstructured key value map stored with a resource that may
 *   be set by external tools to store and retrieve arbitrary metadata. They are not queryable and
 *   should be preserved when modifying objects. More info:
 *   https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations
 * @param creationTimestamp CreationTimestamp is a timestamp representing the server time when this
 *   object was created. It is not guaranteed to be set in happens-before order across separate
 *   operations. Clients may not set this value. It is represented in RFC3339 form and is in UTC.
 *
 * Populated by the system. Read-only. Null for lists. More info:
 * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
 *
 * @param deletionGracePeriodSeconds Number of seconds allowed for this object to gracefully
 *   terminate before it will be removed from the system. Only set when deletionTimestamp is also
 *   set. May only be shortened. Read-only.
 * @param deletionTimestamp DeletionTimestamp is RFC 3339 date and time at which this resource will
 *   be deleted. This field is set by the server when a graceful deletion is requested by the user,
 *   and is not directly settable by a client. The resource is expected to be deleted (no longer
 *   visible from resource lists, and not reachable by name) after the time in this field, once the
 *   finalizers list is empty. As long as the finalizers list contains items, deletion is blocked.
 *   Once the deletionTimestamp is set, this value may not be unset or be set further into the
 *   future, although it may be shortened or the resource may be deleted prior to this time. For
 ...
 * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
 *
 * @param finalizers Must be empty before the object is deleted from the registry. Each entry is an
 *   identifier for the responsible component that will remove the entry from the list. If the
 ...
 * @param generateName GenerateName is an optional prefix, used by the server, to generate a unique
 *   name ONLY IF the Name field has not been provided. If this field is used, the name returned to
 *   the client will be different than the name passed. This value will also be combined with a
 *   unique suffix. The provided value has the same validation rules as the Name field, and may be
 ...
 * @param labels Map of string keys and values that can be used to organize and categorize (scope
 *   and select) objects. May match selectors of replication controllers and services. More info:
 *   https://kubernetes.io/docs/concepts/overview/working-with-objects/labels
 * @param managedFields ManagedFields maps workflow-id and version to the set of fields that are
 ...
 * @param name Name must be unique within a namespace. Is required when creating resources, although
 *   some resources may allow a client to request the generation of an appropriate name
 *   automatically. Name is primarily intended for creation idempotence and configuration
 *   definition. Cannot be updated. More info:
 *   https://kubernetes.io/docs/concepts/overview/working-with-objects/names#names
 * @param namespace Namespace defines the space within which each name must be unique. An empty
 ...
 *
 * @param ownerReferences List of objects depended by this object. If ALL objects in the list have
 *   been deleted, this object will be garbage collected. If this object is managed by a controller,
 *   then an entry in this list will point to this controller, with the controller field set to
 ...
 *   can be used by clients to determine when objects have changed. May be used for optimistic
 ...
 *
 * @param selfLink Deprecated: selfLink is a legacy read-only field that is no longer populated by
 *   the system.
 * @param uid UID is the unique in time and space value for this object. It is typically generated
...
public data class ObjectMeta(
    public val annotations: Map<String, String>,
    public val creationTimestamp: KubernetesTime,
    public val deletionGracePeriodSeconds: Long,
    public val deletionTimestamp: KubernetesTime,
    public val finalizers: List<String>,
    public val generateName: String,
    public val generation: Long,
    public val labels: Map<String, String>,
    public val managedFields: List<ManagedFieldsEntry>,
    public val name: String,
    public val namespace: String,
    public val ownerReferences: List<OwnerReference>,
    ...
    @SerialName("kind") override val kind: String = "ObjectMeta"
}
