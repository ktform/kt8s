 ...
 * @param status Most recently observed status of the pod. This data may not be up to date.
...
public data class Pod(
    ...
    @SerialName("kind") override val kind: String = "Pod"
}
