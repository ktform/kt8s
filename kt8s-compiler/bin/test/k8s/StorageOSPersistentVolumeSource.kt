 ...
 */
@Serializable
public data class StorageOSPersistentVolumeSource(
    public val fsType: String,
    public val readOnly: Boolean,
    public val secretRef: ObjectReference,
    ...
    @SerialName("kind") override val kind: String = "StorageOSPersistentVolumeSource"
}
