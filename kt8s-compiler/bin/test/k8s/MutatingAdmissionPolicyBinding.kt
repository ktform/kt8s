 ...
 */
@Serializable
public data class MutatingAdmissionPolicyBinding(
    public val metadata: ObjectMeta,
    public val spec: MutatingAdmissionPolicyBindingSpec,
) : Resource {
    ...
    @SerialName("kind") override val kind: String = "MutatingAdmissionPolicyBinding"
}
