...
@Serializable
public data class ExternalDocumentation(public val description: String, public val url: String) :
    Resource {
    ...
    @SerialName("kind") override val kind: String = "ExternalDocumentation"
}
