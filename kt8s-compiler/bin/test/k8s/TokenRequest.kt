 ...
 * @param status Status is filled in by the server and indicates whether the token can be
 *   authenticated.
 */
@Serializable
public data class TokenRequest(
    public val metadata: ObjectMeta,
    public val spec: TokenRequestSpec,
    public val status: TokenRequestStatus,
) : Resource {
    ...
    @SerialName("kind") override val kind: String = "TokenRequest"
}
