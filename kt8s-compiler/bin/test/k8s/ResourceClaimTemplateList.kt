 ...
 */
@Serializable
public data class ResourceClaimTemplateList(
    public val items: List<ResourceClaimTemplate>,
    ...
    @SerialName("kind") override val kind: String = "ResourceClaimTemplateList"
}
