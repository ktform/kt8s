 ...
 * @param containerRuntimeVersion ContainerRuntime Version reported by the node through runtime
 *   remote API (e.g. containerd://1.4.2).
 * @param kernelVersion Kernel Version reported by the node from 'uname -r' (e.g.
 ...
 * @param machineID MachineID reported by the node. For unique machine identification in the cluster
 ...
 * @param osImage OS Image reported by the node from /etc/os-release (e.g. Debian GNU/Linux 7
 *   (wheezy)).
 * @param swap Swap Info reported by the node.
 * @param systemUUID SystemUUID reported by the node. For unique machine identification MachineID is
...
public data class NodeSystemInfo(
    ...
    @SerialName("kind") override val kind: String = "NodeSystemInfo"
}
