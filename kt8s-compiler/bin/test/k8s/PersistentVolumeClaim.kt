 ...
 * @param spec spec defines the desired characteristics of a volume requested by a pod author. More
...
public data class PersistentVolumeClaim(
    ...
    @SerialName("kind") override val kind: String = "PersistentVolumeClaim"
}
