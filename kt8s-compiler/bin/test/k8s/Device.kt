 ...
 * @param name Name is unique identifier among all devices managed by the driver in the pool. It
 *   must be a DNS label.
 */
@Serializable
public data class Device(public val basic: BasicDevice, public val name: String) : Resource {
    ...
    @SerialName("kind") override val kind: String = "Device"
}
