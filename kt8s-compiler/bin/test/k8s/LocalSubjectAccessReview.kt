 ...
 * @param spec Spec holds information about the request being evaluated. spec.namespace must be
 ...
 */
@Serializable
public data class LocalSubjectAccessReview(
    ...
    @SerialName("kind") override val kind: String = "LocalSubjectAccessReview"
}
