 ...
 *   other mode bits set.
 * @param items items If unspecified, each key-value pair in the Data field of the referenced Secret
 ...
 * @param secretName secretName is the name of the secret in the pod's namespace to use. More info:
 *   https://kubernetes.io/docs/concepts/storage/volumes#secret
 */
@Serializable
public data class SecretVolumeSource(
    ...
    @SerialName("kind") override val kind: String = "SecretVolumeSource"
}
