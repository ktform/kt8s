 ...
 * @param details Extended data associated with the reason. Each reason may define its own extended
 ...
 * @param reason A machine-readable description of why this operation is in the "Failure" status. If
 *   this value is empty there is no information available. A Reason clarifies an HTTP status code
 *   but does not override it.
 * @param status Status of the operation. One of: "Success" or "Failure". More info:
...
public data class Status(
    ...
    @SerialName("kind") override val kind: String = "Status"
}
