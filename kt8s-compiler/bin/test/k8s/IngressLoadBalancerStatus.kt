...
@Serializable
public data class IngressLoadBalancerStatus(public val ingress: List<IngressLoadBalancerIngress>) :
    Resource {
    ...
    @SerialName("kind") override val kind: String = "IngressLoadBalancerStatus"
}
