 ...
 * @param spec spec represents specification of the desired attach/detach volume behavior. Populated
 *   by the Kubernetes system.
 * @param status status represents status of the VolumeAttachment request. Populated by the entity
...
public data class VolumeAttachment(
    ...
    @SerialName("kind") override val kind: String = "VolumeAttachment"
}
