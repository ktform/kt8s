 ...
 * @param describedObject DescribedObject specifies the descriptions of a object,such as kind,name
 *   apiVersion
...
public data class ObjectMetricStatus(
    ...
    @SerialName("kind") override val kind: String = "ObjectMetricStatus"
}
