...
@Serializable
public data class CertificateSigningRequestList(
    public val items: List<CertificateSigningRequest>,
    ...
    @SerialName("kind") override val kind: String = "CertificateSigningRequestList"
}
