...
@Serializable
public data class PriorityLevelConfigurationReference(public val name: String) : Resource {
    ...
    @SerialName("kind") override val kind: String = "PriorityLevelConfigurationReference"
}
