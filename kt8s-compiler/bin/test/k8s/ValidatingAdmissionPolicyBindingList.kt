 ...
 */
@Serializable
public data class ValidatingAdmissionPolicyBindingList(
    public val items: List<ValidatingAdmissionPolicyBinding>,
    ...
    @SerialName("kind") override val kind: String = "ValidatingAdmissionPolicyBindingList"
}
