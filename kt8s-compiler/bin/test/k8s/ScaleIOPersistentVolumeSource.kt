 ...
 * @param sslEnabled sslEnabled is the flag to enable/disable SSL communication with Gateway,
 *   default false
 ...
 */
@Serializable
public data class ScaleIOPersistentVolumeSource(
    ...
    @SerialName("kind") override val kind: String = "ScaleIOPersistentVolumeSource"
}
