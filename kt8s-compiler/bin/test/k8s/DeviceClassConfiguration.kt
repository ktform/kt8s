...
@Serializable
public data class DeviceClassConfiguration(public val opaque: OpaqueDeviceConfiguration) :
    Resource {
    ...
    @SerialName("kind") override val kind: String = "DeviceClassConfiguration"
}
