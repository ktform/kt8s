...
data class BazelVersion(val bazelVersions: Map<BazelComponent, String> = emptyMap()) :
    ...
    companion object : VersionsFetcher<BazelVersion> by BazelVersionFetcher {
        fun String.toBazelVersion(): BazelVersion =
            BazelVersion(mapOf(BazelComponent.Bazel to this))
    }
}
