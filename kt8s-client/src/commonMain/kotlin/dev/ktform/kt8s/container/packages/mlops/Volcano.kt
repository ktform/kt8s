...
import dev.ktform.kt8s.container.versions.VolcanoVersion.Companion.toVolcanoVersion

class Volcano(val versions: VolcanoVersion) : Renderable {
    constructor(version: String) : this(version.toVolcanoVersion())
