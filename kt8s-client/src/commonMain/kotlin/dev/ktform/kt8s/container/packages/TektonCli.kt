...
import dev.ktform.kt8s.container.versions.TektonVersion.Companion.toTektonCliVersion

class TektonCli(val versions: TektonVersion) : Renderable {
    constructor(version: String) : this(version.toTektonCliVersion())
