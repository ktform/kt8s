...
import dev.ktform.kt8s.container.versions.JavaVersion.Companion.toOpenJ9Version

class OpenJ9Jdk(val versions: JavaVersion) : Renderable {
    constructor(version: String) : this(version.toOpenJ9Version())
