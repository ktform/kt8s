...
import dev.ktform.kt8s.container.versions.ExternalDnsVersion.Companion.toExternalDnsVersion

class ExternalDns(val versions: ExternalDnsVersion) : Renderable {
    constructor(version: String) : this(version.toExternalDnsVersion())
