...
import dev.ktform.kt8s.container.versions.RubyVersion.Companion.toMRubyVersion

class MRuby(val versions: RubyVersion) : Renderable {
    constructor(version: String) : this(version.toMRubyVersion())
