...
import dev.ktform.kt8s.container.versions.PythonVersion.Companion.toPyPyVersion

class PyPy(val versions: PythonVersion) : Renderable {
    constructor(version: String) : this(version.toPyPyVersion())
