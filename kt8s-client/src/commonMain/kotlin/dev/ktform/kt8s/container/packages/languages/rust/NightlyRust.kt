...
import dev.ktform.kt8s.container.versions.RustVersion.Companion.toRustNightlyVersion

class NightlyRust(val versions: RustVersion) : Renderable {
    constructor(version: String) : this(version.toRustNightlyVersion())
    ...
    companion object {
        ...
        val `package` = Package(packageName = "nightlyrust")
    }
}
