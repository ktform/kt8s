...
import dev.ktform.kt8s.container.versions.KubeRayVersion.Companion.toKubeRayVersion

class KubeRay(val versions: KubeRayVersion) : Renderable {
    constructor(version: String) : this(version.toKubeRayVersion())
