...
data class DoCtlVersion(val doCtlVersions: Map<DoCtlComponent, String> = emptyMap()) :
    ...
    companion object : VersionsFetcher<DoCtlVersion> by DoCtlVersionFetcher {
        fun String.toDoCtlVersion(): DoCtlVersion =
            DoCtlVersion(mapOf(DoCtlComponent.DoCtl to this))
    }
}
