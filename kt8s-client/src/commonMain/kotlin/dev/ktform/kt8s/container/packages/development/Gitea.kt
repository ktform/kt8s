...
import dev.ktform.kt8s.container.versions.GiteaVersion.Companion.toGiteaVersion

class Gitea(val versions: GiteaVersion) : Renderable {
    constructor(version: String) : this(version.toGiteaVersion())
