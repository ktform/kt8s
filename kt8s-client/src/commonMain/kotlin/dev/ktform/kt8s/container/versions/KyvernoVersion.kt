...
data class KyvernoVersion(val kyvernoVersions: Map<KyvernoComponent, String> = emptyMap()) :
    ...
    companion object : VersionsFetcher<KyvernoVersion> by KyvernoVersionFetcher {
        fun String.toKyvernoVersion(): KyvernoVersion =
            KyvernoVersion(mapOf(KyvernoComponent.Kyverno to this))
    }
}
