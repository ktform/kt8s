...
import dev.ktform.kt8s.container.versions.TektonVersion.Companion.toTektonTriggersVersion

class TektonTriggers(val versions: TektonVersion) : Renderable {
    constructor(version: String) : this(version.toTektonTriggersVersion())
