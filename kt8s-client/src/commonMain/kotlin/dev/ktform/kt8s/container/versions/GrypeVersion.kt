...
data class GrypeVersion(val grypeVersions: Map<GrypeComponent, String> = emptyMap()) :
    ...
    companion object : VersionsFetcher<GrypeVersion> by GrypeVersionFetcher {
        fun String.toGrypeVersion(): GrypeVersion =
            GrypeVersion(mapOf(GrypeComponent.Grype to this))
    }
}
