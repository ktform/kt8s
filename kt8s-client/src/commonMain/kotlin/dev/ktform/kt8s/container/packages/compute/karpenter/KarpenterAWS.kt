...
import dev.ktform.kt8s.container.versions.KarpenterVersion.Companion.toKarpenterAwsVersion

class KarpenterAWS(val versions: KarpenterVersion) : Renderable {
    constructor(version: String) : this(version.toKarpenterAwsVersion())
