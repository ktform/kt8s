...
import dev.ktform.kt8s.container.versions.PythonVersion.Companion.toPythonVersion

class CPython(val versions: PythonVersion) : Renderable {
    constructor(version: String) : this(version.toPythonVersion())
    ...
    companion object {
        ...
        val `package` = Package(packageName = "cpython")
    }
}
