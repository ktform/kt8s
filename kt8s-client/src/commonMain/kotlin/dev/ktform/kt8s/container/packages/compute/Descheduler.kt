...
import dev.ktform.kt8s.container.versions.DeschedulerVersion.Companion.toDeschedulerVersion

class Descheduler(val versions: DeschedulerVersion) : Renderable {
    constructor(version: String) : this(version.toDeschedulerVersion())
