...
import dev.ktform.kt8s.container.versions.TektonVersion.Companion.toTektonPipelineVersion

class TektonPipeline(val versions: TektonVersion) : Renderable {
    constructor(version: String) : this(version.toTektonPipelineVersion())
