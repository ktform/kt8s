...
import dev.ktform.kt8s.container.versions.FeastVersion.Companion.toFeastVersion

class Feast(val versions: FeastVersion) : Renderable {
    constructor(version: String) : this(version.toFeastVersion())
