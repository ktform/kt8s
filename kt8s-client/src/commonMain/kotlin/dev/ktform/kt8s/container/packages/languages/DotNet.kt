...
import dev.ktform.kt8s.container.versions.DotNetVersion.Companion.toDotNetVersion

class DotNet(val versions: DotNetVersion) : Renderable {
    constructor(version: String) : this(version.toDotNetVersion())
