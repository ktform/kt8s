...
import dev.ktform.kt8s.container.versions.TektonVersion.Companion.toTektonDashboardVersion

class TektonDashboard(val versions: TektonVersion) : Renderable {
    constructor(version: String) : this(version.toTektonDashboardVersion())
