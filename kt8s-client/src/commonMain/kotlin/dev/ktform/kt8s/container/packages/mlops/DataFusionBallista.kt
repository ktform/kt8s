...
import dev.ktform.kt8s.container.versions.DataFusionBallistaVersion.Companion.toDataFusionBallistaVersion

class DataFusionBallista(val versions: DataFusionBallistaVersion) : Renderable {
    constructor(version: String) : this(version.toDataFusionBallistaVersion())
