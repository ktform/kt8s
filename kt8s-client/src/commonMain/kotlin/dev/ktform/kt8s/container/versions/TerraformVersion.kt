...
data class TerraformVersion(val terraformVersions: Map<TerraformComponent, String> = emptyMap()) :
    Versions<TerraformVersion>(
        terraformVersions.mapKeys { it.key as Component<TerraformVersion> }
    ) {
    companion object : VersionsFetcher<TerraformVersion> by TerraformVersionFetcher {
        fun String.toTerraformVersion(): TerraformVersion =
            TerraformVersion(mapOf(TerraformComponent.Terraform to this))
    }
}
