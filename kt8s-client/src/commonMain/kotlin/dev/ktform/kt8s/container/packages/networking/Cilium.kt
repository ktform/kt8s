...
import dev.ktform.kt8s.container.versions.CiliumVersion.Companion.toCiliumVersion

class Cilium(val versions: CiliumVersion) : Renderable {
    constructor(version: String) : this(version.toCiliumVersion())
