...
import dev.ktform.kt8s.container.versions.NodeJsVersion.Companion.toNodeJsVersion

class NodeJs(val versions: NodeJsVersion) : Renderable {
    constructor(version: String) : this(version.toNodeJsVersion())
