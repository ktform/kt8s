...
data class KedaVersion(val kedaVersions: Map<KedaComponent, String> = emptyMap()) :
    ...
    companion object : VersionsFetcher<KedaVersion> by KedaVersionFetcher {
        fun String.toKedaVersion(): KedaVersion = KedaVersion(mapOf(KedaComponent.Keda to this))
    }
}
