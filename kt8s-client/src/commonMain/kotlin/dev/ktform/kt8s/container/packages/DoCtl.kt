...
import dev.ktform.kt8s.container.versions.DoCtlVersion.Companion.toDoCtlVersion

class DoCtl(val versions: DoCtlVersion) : Renderable {
    constructor(version: String) : this(version.toDoCtlVersion())
