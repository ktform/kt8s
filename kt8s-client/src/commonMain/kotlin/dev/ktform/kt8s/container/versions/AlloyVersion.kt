...
data class AlloyVersion(val alloyVersions: Map<AlloyComponent, String> = emptyMap()) :
    ...
    companion object : VersionsFetcher<AlloyVersion> by AlloyVersionFetcher {
        fun String.toAlloyVersion(): AlloyVersion =
            AlloyVersion(mapOf(AlloyComponent.Alloy to this))
    }
}
