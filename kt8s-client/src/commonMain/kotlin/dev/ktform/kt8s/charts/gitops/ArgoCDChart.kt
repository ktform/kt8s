...
data class ArgoCDChart(override val versions: ArgoVersion = ArgoVersion()) : Chart<ArgoVersion> {
    override val group: ChartGroup = ChartGroup.GitOps

    override fun getComponents(): List<ArgoComponent> = listOf(ArgoComponent.ArgoCD)
