...
data class TektonTriggersChart(override val versions: TektonVersion) : Chart<TektonVersion> {
    override val group: ChartGroup = ChartGroup.GitOps

    override fun getComponents(): List<TektonComponent> = listOf(TektonComponent.TektonTriggers)
