...
data class CorazaChart(override val versions: CorazaVersion) : Chart<CorazaVersion> {
    override val group: ChartGroup = ChartGroup.Networking

    override fun getComponents(): List<CorazaComponent> = listOf(CorazaComponent.Coraza)
